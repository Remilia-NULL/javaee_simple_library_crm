...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户信息修改</strong> /
                <small>USER</small>
            </div>
        </div>
        <form class="am-form" action="/Admin/edituserin.html" method="post">
            <div class="am-g am-margin-top">
                <div class="am-u-sm-2 am-text-right">
                    用户UUID：
                </div>
                <div class="am-u-sm-4">
                    <input type="text" name="uuid" class="am-input-sm" value="${UserData.nor_uuid}"
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="text" name="name" class="am-input-sm" value="${UserData.nor_name}" required>
                </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="password" name="password" class="am-input-sm" value="${UserData.nor_password}"
                           required>
                </div>
                <div class="am-u-sm-6">*必填</div>
            </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="email" name="email" class="am-input-sm" value="${UserData.nor_email}" required>
                </div>
                <div class="am-u-sm-6">*必填</div>
            </div>
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="number" name="static" class="am-input-sm" value="${UserData.nor_static}" required>
                </div>
                <div class="am-u-sm-6">*必填</div>
            </div>
