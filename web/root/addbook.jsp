...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加图书</strong> /
                <small>ADDBOOK</small>
            </div>
        </div>
        <form class="am-form" action="/Admin/addBook.html" method="post">
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="text" name="name" class="am-input-sm" required>
                </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="text" name="isbn" class="am-input-sm" required>
                </div>
                <div class="am-u-sm-6">*必填</div>
            </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="text" name="author" class="am-input-sm" required>
                </div>
                <div class="am-u-sm-6">*必填</div>
            </div>
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="number" name="price" class="am-input-sm" required>
                </div>
                <div class="am-u-sm-6">*必填</div>
            </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="text" name="remarks" class="am-input-sm">
                </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="number" name="bookstatic" class="am-input-sm" required>
                </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="number" name="remsining" class="am-input-sm" required>
                </div>
                <div class="am-u-sm-6">*必填</div>
            </div>
