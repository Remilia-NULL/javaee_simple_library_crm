...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">书籍信息</strong> /
                <small>BOOK</small>
            </div>
        </div>
                ...
                <div class="am-fl am-cf">
                    <div class="am-btn-toolbar am-fl">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="/Admin/addbookpage.html" type="button" class="am-btn am-btn-default"><span
            ...
            <div class="am-u-sm-12">
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        <thead>
                        <tr>
                            <th class="table-id">图书UUID</th>
                            <th class="table-title">书籍名称</th>
                            <th class="table-type">书籍作者</th>
                            <th class="table-author">书籍ISBN</th>
                            <th class="table-author">价格</th>
                            <th class="table-author">备注</th>
                            <th class="table-author">是否借出</th>
                            <th class="table-author">剩余数</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${BOOK_DATA}" var="bookData">
                            <tr>
                                <td>${bookData.book_uuid}</td>
                                <td>${bookData.book_name}</td>
                                <td>${bookData.book_author}</td>
                                <td>${bookData.book_isbn}</td>
                                <td>${bookData.book_price}</td>
                                <td>${bookData.book_remarks}</td>
                                <td>${bookData.book_static}</td>
                                <td>${bookData.book_remsining}</td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="/Admin/editbookout.html?uuid=${bookData.book_uuid}"
                                               class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                    class="am-icon-pencil-square-o"></span> 编辑
                                            </a>

                                            <a href="/Admin/deleteBook.html?uuid=${bookData.book_uuid}"
