...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <form class="am-form" action="/Normal/signupcheck.html" method="post">
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="email" name="email" class="am-input-sm" required>
                </div>
                <div class="am-u-sm-6">*必填，不可重复</div>
            </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-4">
                    <input type="password" name="passwd" class="am-input-sm" required>
                </div>
